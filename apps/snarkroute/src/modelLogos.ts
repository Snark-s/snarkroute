...
const logos = {
  ...
  blackForestLabs: { label: "Black Forest Labs", src: logoSvg('<path d="M13 16h16v10H23v8h9v10H23v8H13V16Zm23 0h14v10h-4v26H36V16Z" fill="#f4f6fb"/>', "#090909") },
  bytedance: { label: "ByteDance", src: logoSvg('<path d="M14 36c7-7 11-12 18-14 8-2 13 3 18 6-7 1-12 0-18 5-5 4-9 8-18 8v-5Z" fill="#21c2ff"/><path d="M14 29c7-7 11-12 18-14 8-2 13 3 18 6-7 1-12 0-18 5-5 4-9 8-18 8v-5Z" fill="#fb3869" opacity=".88"/>', "#101014") },
  ...
  kling: { label: "Kling", src: logoSvg('<path d="M18 14v36m0-14 27-22M18 36l27 14" fill="none" stroke="#f7f7f5" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/>', "#111111") },
  qwen: { label: "Qwen", src: logoSvg('<circle cx="32" cy="30" r="16" fill="none" stroke="#7468ff" stroke-width="7"/><path d="m35 38 12 12" stroke="#a9a2ff" stroke-width="7" stroke-linecap="round"/>', "#101124") },
  topaz: { label: "Topaz Labs", src: logoSvg('<path d="M12 18h40L32 52 12 18Zm11 8 9 15 9-15H23Z" fill="#45d5d1"/>', "#101a20") },
  wan: { label: "Wan", src: logoSvg('<path d="M10 19h8l6 25 7-19h5l7 19 5-25h7L48 50h-9l-6-16-6 16h-9L10 19Z" fill="#66c8ff"/>', "#081724") },
  yandex: { label: "Yandex", src: logoSvg('<path d="M18 14h12c11 0 16 6 16 15 0 6-3 11-9 13l10 10H36L27 42v10H18V14Zm9 8v13h3c5 0 7-2 7-7 0-4-2-6-7-6h-3Z" fill="#fc3f1d"/>', "#151515") },
...
const aliases: Array<[RegExp, keyof typeof logos]> = [
  ...
  [/black-forest-labs|flux/i, "blackForestLabs"],
  [/bytedance|seedance|seedream/i, "bytedance"],
  [/gpt|dall-?e|openai/i, "openai"],
  [/llama|meta/i, "meta"],
  [/mistral|mixtral|pixtral/i, "mistral"],
  [/stable-diffusion|stability/i, "stability"],
  [/kling/i, "kling"],
  [/qwen|tongyi-mai/i, "qwen"],
  [/topaz/i, "topaz"],
  [/^wan(?:\s|\/)|\swan\//i, "wan"],
  [/yandex/i, "yandex"],
  [/grok|x-ai|xai/i, "xai"],
