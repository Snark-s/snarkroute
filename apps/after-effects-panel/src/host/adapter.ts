import type { CompositionSnapshot, GenerationMetadata, HostItemReference, ImportedFootageDiagnostic, LayerReplacementDiagnostic, ProjectFileContext, RenderedAsset, ValidatedInputFile } from "../types";
